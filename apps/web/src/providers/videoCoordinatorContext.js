import { createContext, useContext, useId, useMemo, useRef, useEffect } from 'react';
...
export const VideoApiContext = createContext(null);     // stable: methods + position map
export const VideoActiveContext = createContext(null);  // changes: active instance id
