...
2. Check the "Done when" line:
   ...
   - If Type is visual → use Playwright to load the affected page and take a screenshot at 390px wide and at 1280px wide. The task passes only if the screenshots show the "Done when" is actually met.
